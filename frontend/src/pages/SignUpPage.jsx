...
const SignUpPage = () => {
	...
	const handleSubmit = (e) => { //When an event (e.g., submit, click, change) occurs in the browser, an event object is automatically passed to the event handler function.
		e.preventDefault();
		signup(formData);
	};
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<button
									...
									tabIndex={-1} // prevents it from getting focus when tabbing through form
								>
